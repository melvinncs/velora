    ...
    <section className="w-full bg-white px-6 py-16 sm:px-12 lg:px-20">
      <div className="mx-auto flex max-w-[1280px] flex-col gap-12">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
          ...
          {/* Card 1: Brand Aware Content Engine (Span 5) */}
          <div className="flex flex-col justify-between rounded-[24px] border border-[#f0f0f0] bg-[#f7f7f7] p-5 sm:p-6 lg:col-span-5">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm leading-relaxed text-[#878787]">
                Generates copy and graphics aligned perfectly with your brand tone, guidelines, and target audience.
              </p>
            </div>
          </div>

          {/* Card 2: Omnichannel Auto-Publishing (Span 7) */}
          <div className="flex flex-col justify-between gap-6 overflow-hidden rounded-[24px] border border-[#f0f0f0] bg-[#f7f7f7] p-6 sm:flex-row sm:items-center sm:p-8 lg:col-span-7">
            <div className="flex flex-1 flex-col gap-2 sm:max-w-[280px]">
              ...
              <p className="text-sm leading-relaxed text-[#878787]">
                Schedule and auto-post tailored formats across Instagram, LinkedIn, TikTok, and X seamlessly.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
          ...
          {/* Card 3: Performance & ROI Analytics (Span 7) */}
          <div className="flex flex-col justify-between gap-8 rounded-[24px] border border-[#f0f0f0] bg-[#f7f7f7] p-6 sm:p-8 lg:col-span-7">
            
            {/* Visual Workflow Diagram */}
            <div className="flex flex-col items-center justify-center gap-4 py-4 sm:flex-row sm:gap-6">
              
              {/* Incoming Message Box */}
              <div className="flex flex-col items-center gap-3 rounded-[20px] bg-white p-4 shadow-sm border border-gray-100 shrink-0">
              ...
              <div className="hidden text-gray-300 sm:block">
                <svg width="24" height="120" viewBox="0 0 24 120" fill="none" stroke="currentColor" strokeWidth="1.5">
                  <path d="M2 10 C 12 10, 12 60, 22 60 C 12 60, 12 110, 2 110" />
                </svg>
              </div>

              {/* Stacked AI Response Cards */}
              <div className="flex w-full flex-col gap-2.5 sm:max-w-[320px]">
                
                {/* Item 1 */}
                <div className="flex items-start gap-3 rounded-[16px] bg-white p-3 shadow-sm border border-gray-100">
                  ...
                  <div className="flex flex-col gap-0.5">
                    ...
                    <p className="text-[11px] leading-tight text-gray-500">
                      Instant responses for common questions without manual input.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 rounded-[16px] bg-white p-3 shadow-sm border border-gray-100">
                  ...
                  <div className="flex flex-col gap-0.5">
                    ...
                    <p className="text-[11px] leading-tight text-gray-500">
                      Identify intent and route high-quality leads to the right team.
                    </p>
                  </div>
                </div>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex flex-col gap-1 max-w-sm">
                ...
                <p className="text-sm text-[#878787]">
                  Track engagement, audience growth, and top-performing posts with actionable AI recommendations.
                </p>
              </div>
          ...
          {/* Card 4: Smart Content Workflows (Span 5) */}
          <div className="flex flex-col justify-between gap-6 rounded-[24px] border border-[#f0f0f0] bg-[#f7f7f7] p-6 sm:p-8 lg:col-span-5">
            
            {/* Area Chart Card UI */}
            <div className="flex flex-col rounded-[20px] bg-white p-4 shadow-sm border border-gray-100">
              ...
              <div className="relative mt-4 h-40 w-full">
                ...
                {/* Floating Grow Badge */}
                <div className="absolute top-4 right-12 z-10 flex items-center gap-1 rounded-full bg-white px-2.5 py-1 text-[10px] font-semibold text-[#8ebf00] shadow-md border border-gray-100">
                  <Zap className="size-3 fill-current" />
                  <span>Grow 82% in this month</span>
                </div>

                {/* SVG Graph Curve & Gradient */}
            ...
            <div className="flex flex-col gap-2 mt-4">
              ...
              <p className="text-sm leading-relaxed text-[#3b3b3b]">
                Turn a single blog post or video idea into 20+ social assets across all channels instantly.
              </p>
            </div>
